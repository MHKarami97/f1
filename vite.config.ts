  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          { src: '/icon48.png', sizes: '48x48', type: 'image/png', purpose: 'any' },
          { src: '/icon72.png', sizes: '72x72', type: 'image/png', purpose: 'any' },
          { src: '/icon96.png', sizes: '96x96', type: 'image/png', purpose: 'any' },
          { src: '/icon144.png', sizes: '144x144', type: 'image/png', purpose: 'any' },
